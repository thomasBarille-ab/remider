...
export function Statistics() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
      {/* Overview Card */}
      <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-center items-center">
         <h3 className="text-gray-500 font-semibold mb-2">Completion Rate</h3>
         <div className="relative w-32 h-32 flex items-center justify-center">
            ...
            <span className="absolute text-2xl font-bold text-gray-800">{completionStats.rate}%</span>
         </div>
         <p className="text-sm text-gray-400 mt-2">{completionStats.completed} / {completionStats.total} Tasks Done</p>
      </div>

      {/* Category Distribution */}
      <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
        <h3 className="text-gray-500 font-semibold mb-4 text-center">Tasks by Category</h3>
      ...
      <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 md:col-span-2">
        <h3 className="text-gray-500 font-semibold mb-4">Weekly Activity</h3>
        <div className="h-48 w-full">
           <ResponsiveContainer width="100%" height="100%">
